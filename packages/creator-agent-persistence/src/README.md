...
- `catalog-types.ts`：Catalog 错误、配置、Draft/Version reference 与最小公共 port。
...
- `sqlite-catalog.ts`：strict handoff import、完整 freeze review、exact confirmation、幂等 Version freeze 与跨行
  lineage validator。
