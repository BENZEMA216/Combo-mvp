...
- `demo/` 只为 `COMBO_ENVIRONMENT=test` 提供固定 Combo Miniapp 评审种子。它要求登录、可信来源、owner 与完整 fixture marker，并复用正常 Studio、Artifact、对象存储和当前 UI 指针；Preview、Production 与 development 不注册该路由。
